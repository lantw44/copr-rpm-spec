...
Patch1:         vte-0.66-reduce-line-height.patch
...
%description
Copr: lantw44/vte-reduce-line-height
Note: This is a modified package. Install it if you want to reduce the line
height by disabling the new way to calculate line height introduced in VTE 0.64.
...
%package        gtk4
Summary:        GTK4 terminal emulator library (Copr: lantw44/vte-reduce-line-height)
